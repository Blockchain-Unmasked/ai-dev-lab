...
# Security middleware for token verification (define this BEFORE using it)
...
# IMPORTANT: API endpoints must be defined BEFORE the catch-all route
...
async def serve_frontend_files(file_path: str):
    ...
    # Skip API endpoints (shouldn't reach here if routes are ordered correctly)
